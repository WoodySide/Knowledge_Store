                                            ...
                                            <td class="tw-card-body"
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    <span style="font-weight: 400;">Thank you for joining <strong>Knowledge Tree App</strong>, an efficient and smart solution to manage all kinds of resources all over the internet!</span><br/><br/><span
                                                ...
                                                <p class="tw-signoff"
                                                   style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    Our best, <br/>Knowledge Tree App team</p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
